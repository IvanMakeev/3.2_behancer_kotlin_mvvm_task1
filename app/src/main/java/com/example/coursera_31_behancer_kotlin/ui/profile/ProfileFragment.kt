...
import com.example.coursera_31_behancer_kotlin.utils.ProfileViewModelFactory
...
class ProfileFragment : Fragment() {
    ...
    private var onProjectsClickListener: View.OnClickListener? = null
    ...
    override fun onAttach(context: Context?) {
        ...
        if (context is Storage.StorageOwner) {
            ...
            val factory = ProfileViewModelFactory(storage, username)
            profileViewModel = ViewModelProviders.of(this,factory).get(ProfileViewModel::class.java)

            onProjectsClickListener = View.OnClickListener {
            ...
            profileViewModel.onClickListener = onProjectsClickListener
        }
    }
    ...
    override fun onDetach() {
        super.onDetach()
        profileViewModel.onClickListener = null
    }
}